...
<html>
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Ninebot Max G30 Custom Firmware Toolkit">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" type="image/png" href="/static/favicon.png">
    <meta name="author" content="BotoX">

    <title>Ninebot Max G30 Custom Firmware Toolkit</title>
  ...
  <body>
    ...
    <div class="container-fluid">
      <h1 class="text-center">Ninebot Max G30 Custom Firmware Toolkit</h1>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="btn-group" role="group" aria-label="Presets">
                ...
                <button type="button" class="btn btn-primary preset preset--speed">Unlock your speed</button>
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="row-fluid">
        <form action="https://get.scooterhacking.org/max" onsubmit="return confirm('Do you really want to generate your CFW? This is an experimental tool!');">
          <!-- Driver Version -->
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              >
                <option value="DRV126" selected>1.2.6</option>
              </select>
          ...
          <!-- Speed params - normal max speed -->
          <div class="form-group row">
            <label for="speed-normal-kmh" class="col-sm-2 col-form-label">"Drive" max speed</label>
            <div class="col-sm-10">
              <div class="input-group">
                <input name="speed_normal_kmh" type="number" step="1" min="5" max="65" value="33" class="form-control" disabled>
          ...
          <!-- Speed params - normal phase current -->
          <div class="form-group row">
            <label for="speed-normal-phase" class="col-sm-2 col-form-label">"Drive" phase current</label>
            <div class="col-sm-10">
              <div class="input-group">
                <input name="speed_normal_phase" type="number" step="1" min="5" max="65535" value="55000" class="form-control" disabled>
                <div class="input-group-append">
                  <label class="input-group-text">
                    <input class="patch-input" type="checkbox"> &nbsp;Patch?
                  </label>
          ...
          <!-- Speed params - normal battery current -->
          <div class="form-group row">
            <label for="speed-normal-battery" class="col-sm-2 col-form-label">"Drive" battery current</label>
            <div class="col-sm-10">
              <div class="input-group">
                <input name="speed_normal_battery" type="number" step="1" min="5" max="65535" value="25000" class="form-control" disabled>
                <div class="input-group-append">
                  <label class="input-group-text">
                    <input class="patch-input" type="checkbox"> &nbsp;Patch?
                  </label>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                <input class="form-control" name="motor_power_constant" type="number" step="1" min="25000" max="65535" value="51575" disabled>
                <div class="input-group-append">
                  <label class="input-group-text">
                    <input class="patch-input" type="checkbox"> &nbsp;Patch?
                  </label>
          ...
          <div class="form-group row">
            <div class="col">
              ...
              <small id="bypass-bms-help" class="form-text text-muted">
                ...
                <i>Warning: the scooter won't provide any info on the current battery state, voltage, or remaining capacity.</i>
              </small>
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col">
              ...
              <small id="change-esc-bms-rate-help" class="form-text text-muted">
                Only if you use the <a href="https://max.scooterhacking.org/#">nonexistent compatible open source BMS!</a>
              </small>
            </div>
          </div>
          ...
          <div class="jumbotron jumbotron-fluid">
            <div class="col">
              <button class="btn btn-secondary" disabled>Share config</button>
        ...
        <div class="alert alert-primary">
          <i class="fas fa-code-branch"></i> Source code on <a href="https://github.com/scooterhacking/ninebot-max-g30-firmware-patcher" class="alert-link">GitHub</a>
        </div>
